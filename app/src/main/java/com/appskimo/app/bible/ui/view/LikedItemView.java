...
@EViewGroup(R.layout.view_liked_item)
public class LikedItemView extends RelativeLayout {
    ...
    private OnLikeListener likeListener = new OnLikeListener() {
        ...
        public void liked(LikeButton likeButton) {
            EventBus.getDefault().post(new Like(Like.From.LIKE, content.getContentUid(), true));
            bibleService.toggleLikeContent(content, true);
        }

        @Override
        public void unLiked(LikeButton likeButton) {
            EventBus.getDefault().post(new Like(Like.From.LIKE, content.getContentUid(), false));
    ...
    private OnLikeListener checkListener = new OnLikeListener() {
        ...
        public void liked(LikeButton likeButton) {
            ...
            Spannable spannable = new SpannableStringBuilder(content.getContents(edition));
            ...
            EventBus.getDefault().post(new OnCheck(content, OnCheck.From.LIKE));
        }
    ...
    public LikedItemView(Context context) {
        super(context);
    }

    public LikedItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setRecord(int position, Content content) {
        ...
        Edition edition = getEdition();
        infoView.setText(content.getSimpleInfo(edition));
        ...
        if (content.isChecked()) {
            ...
            contentView.setText(content.getContents(edition));
        }
    }
