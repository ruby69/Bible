...
import com.appskimo.app.bible.Constants;
import com.appskimo.app.bible.LockActivity_;
...
public class ScreenOffService extends Service {
    ...
    private static final String ACTION_STOP_SERVICE = "com.appskimo.app.bible.support.ScreenOffService.ACTION_STOP_SERVICE";
    private static final String NOTI_CHANNEL_ID = "bible_screen_off";
